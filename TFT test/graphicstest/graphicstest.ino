...
#define sclk 14  // SCLK can also use pin 13
#define mosi 7  // MOSI can also use pin 11
#define cs   2  // CS & DC can use pins 2, 6, 9, 10, 15, 20, 21, 22, 23
#define dc   3   //  ut9uf !!!!!!  but certain _pairs_ must NOT be used: 2+10, 6+9, 20+23, 21+22
